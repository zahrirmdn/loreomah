...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-900 via-amber-800 to-amber-900 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        {/* Logo */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-white rounded-full mb-4">
            <span className="text-3xl font-bold text-amber-900">CL</span>
          </div>
          ...
          <TabsContent value="login">
            <div className="bg-white rounded-lg shadow-2xl p-8">
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <Button type="submit" className="w-full bg-amber-800 hover:bg-amber-900 text-white py-6">
                  Login
                </Button>
